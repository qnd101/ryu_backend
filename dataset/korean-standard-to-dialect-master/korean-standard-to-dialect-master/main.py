...
parser.add_argument('--dialect', action='store', dest='dialect', default='ryu',
                    help='Target Dialect')
...
path_gs_train = './dataset/dataset/ryutrain.json'
path_gs_test = './dataset/dataset/ryutrain.json'
